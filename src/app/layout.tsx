              ...
              <div style={{ display: 'flex', flexDirection: 'column', width: '100%', gap: '24px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '16px' }}>
                    <a href="https://github.com/wpmvc" target="_blank" rel="noreferrer" className="footer-social-link">
                    ...
                    <a href="https://x.com/wpmvcofficial" target="_blank" rel="noreferrer" className="footer-social-link">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
