...
The `paginate` method returns a `WpMVC\Database\Pagination\Paginator` instance, which provides methods for the total count, total pages, and is convertible to an array or JSON.
