---
sidebarTitle: Classic Editor
title: Classic Editor
description: ClassicEditor is a React component that seamlessly integrates the WordPress Classic Editor using the wp.editor API.
---
...
```tsx copy filename="src/admin/components/MyCustomEditor.tsx"
...
```php copy filename="functions.php"
<?php
/**
